...
extension UIView {
    ...
    func inputContainerView(withTextField textField: UITextField? = nil, withImage image: UIImage, segmentedControl: UISegmentedControl? = nil) -> UIView {
        let view = UIView()
        ...
        if let sc = segmentedControl {
            imageView.anchor(top: view.topAnchor, left: view.leftAnchor, paddingTop: -8,
                             paddingLeft: 8, height: 24, width: 24)
...
extension UITextField {
    ...
    func textField(withPlaceholder placeholer: String, isSecureTextEntry: Bool) -> UITextField {
        ...
        tf.attributedPlaceholder = NSAttributedString(string: placeholer,
